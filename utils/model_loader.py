        ...
        if raw:
            try:
                ...
                if not isinstance(parsed, dict):
                    raise ValueError("LLM_API_KEYS is not a valid JSON object")
                self.llm_api_keys = parsed
                log.info("Loaded LLM_API_KEYS from ECS secret")
            except Exception as e:
                log.warning("Failed to parse LLM_API_KEYS as JSON", error=str(e))
